...
function getDownloadUrlByVideoId(videoId) {
    return __awaiter(this, void 0, void 0, function () {
        var response, _a, _b, _c, code, msg, data, durl, url;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _b = (_a = JSON).parse;
                    return [4 /*yield*/, req_1.httpGet('https://api.live.bilibili.com/room/v1/Room/playUrl', { cid: videoId })];
                case 1:
                    response = _b.apply(_a, [_d.sent()]);
                    _c = response, code = _c.code, msg = _c.msg, data = _c.data;
